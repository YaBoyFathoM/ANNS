...
function newbounty(element,difficultystring,bounty) {
    ...
    $w("#bountyamounttext").text=($w("#postbountyamount").value).toString();
    let tempwallet = (Number($w("#currentkarma").text)-$w("#postbountyamount").value).toString();
    let t=0
    ...
    t++
      ...
      $w("#bountyamounttext").html = `<h3 class="wixui-rich-text__text" style="font-size:50px"><span style="text-shadow:#ffffff 0px 0px 6px" class="wixui-rich-text__text"><span style="font-weight:normal" class="wixui-rich-text__text"><span style="color:#000000" class="wixui-rich-text__text"><span style="font-family:wfont_edfbfb_ee9003cfe4fb457aa3af4884ade40b22,wf_ee9003cfe4fb457aa3af4884a,orig_neon_sans" class="wixui-rich-text__text">${$w("#bountyamounttext").text}</span></span></span></span></h3>`;
        ...
        changing=false
          ...
          $w('#bountycard').postMessage({bountytitle: $w("#postbountyname").value, difficulty: difficultystring, bountydescription: $w("#postbountydisc").value});
...
$w("#postbountyamount").onChange(() => {
  $w("#bountyamounttext").text = $w("#postbountyamount").value.toString();
  tempwallet = (Number(tempwallet) - $w("#postbountyamount").value).toString();
  ...
  $w("#newbountybutton").onClick( () => {
    let spentkarma=$w("#postbountyamount").value
    changing=true
    if (Number(tempwallet)-spentkarma >= 0) {
      let newbountysubmission = {
        "reward": $w("#postbountyamount").value.toString(),
        ...
        "difficulty":difficultystring,
                ...
                $w("#loadinggif").show();
                updateText($w("#postbountyamount").value-$w("#postbountyamount").min);
                }
            });
}
function claimbounty(element,bounty) {
  ...
  element.hide();
  $w('#bountycard').show()
  $w('#bountycard').postMessage(bounty);
...
$w('#bountycard').postMessage({bountytitle: "_", difficulty: previousDifficultystring, bountyDescription: "_"});
      ...
      setTimeout(function() {
      $w('#bountycard').postMessage({bountytitle: "_", difficulty: previousDifficultystring, bountyDescription: "Bounty Complete"});
      element.collapse();
      setTimeout(function() {
      $w('#bountycard').postMessage({bountytitle: "_", difficulty: previousDifficultystring, bountyDescription: "_"});
      $w("#bountycard").hide("fade",{delay:2000,duration:200});
...
function showDifficulty(difficultystring) {
  ...
  $w('#bountycard').postMessage({bountytitle: "_", difficulty: difficultystring, bountydescription: "_"});
...
.then(results => {
  ...
  wixData.query(collection)
    ...
    $w("#bountycard").show("fade", {delay:200,duration: 300});
    $w("#bountyamounttext").html = buildhtml("50",bright,$w("#bountyamounttext").text);
    $w("#currentkarma").html = `<h3 class="wixui-rich-text__text" style="text-align:right;font-size:50px"><span style="text-shadow:#ffffff 0px 0px 6px" class="wixui-rich-text__text"><span style="font-weight:normal" class="wixui-rich-text__text"><span style="color:${bright}" class="wixui-rich-text__text"><span style="font-family:wfont_edfbfb_ee9003cfe4fb457aa3af4884ade40b22,wf_ee9003cfe4fb457aa3af4884a,orig_neon_sans" class="wixui-rich-text__text">${$w("#currentkarma").text}</span></span></span></span></h3>`;
    $w("#urmoney").show("roll", { duration: 500,direction:"right"});
    $w("#accountbox").show("roll", { duration: 500,direction:"right"});
  ...
  for (let i = 0; i < bounties.length; i++) {
      ...
      description = bounties[i].bountydescription;
      setTimeout(() => {
      $w('#bountycard').postMessage(bounties[i]);
      }, 690);
      }
  ...
  element.onClick(function () {
    ...
    if (selected !== element) {
      ...
      $w("#bountycard").show("fade",{duration:500});
      if (element.text !="+"){
      claimbounty(element,bounties[i]);
        ...
        if (Number($w("#currentkarma").text) < $w("#postbountyamount").value) {
        $w("#newbountybutton").disable();
        $w("#currentkarma").html = `<h3 class="wixui-rich-text__text" style="text-align:right;font-size:50px"><span style="text-shadow:#ffffff 0px 0px 6px" class="wixui-rich-text__text"><span style="font-weight:normal" class="wixui-rich-text__text"><span style="color:#000000" class="wixui-rich-text__text"><span style="font-family:wfont_edfbfb_ee9003cfe4fb457aa3af4884ade40b22,wf_ee9003cfe4fb457aa3af4884a,orig_neon_sans" class="wixui-rich-text__text">${$w("#currentkarma").text}</span></span></span></span></h3>`;
        $w("#bountyamounttext").html = `<h3 class="wixui-rich-text__text" style="font-size:50px"><span style="text-shadow:#ffffff 0px 0px 6px" class="wixui-rich-text__text"><span style="font-weight:normal" class="wixui-rich-text__text"><span style="color:#000000" class="wixui-rich-text__text"><span style="font-family:wfont_edfbfb_ee9003cfe4fb457aa3af4884ade40b22,wf_ee9003cfe4fb457aa3af4884a,orig_neon_sans" class="wixui-rich-text__text">${$w("#bountyamounttext").text}</span></span></span></span></h3>`;
        } else {
...
$w("#forum1").show("roll", {delay:1000,duration: 500, direction: "left" });
...
$w("#leaderboardup").onClick(function () {
        ...
        $w("#leaderboardvideo").hide("roll", {delay:1000,duration:1000,direction:"top"});
